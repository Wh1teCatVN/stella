...
const meetXueruButton = document.getElementById('meet-xueru-button'); // Added
...
const translations = {
    ...
    'meet-xueru-text': { 'vi': 'gặp gỡ Xueru', 'en': 'Meet Xueru', 'zh-tw': '遇見雪茹' }, // Added
...
// --- Hàm updateContent và updateTogglePersonaButton ---
function updateContent(lang) {
    ...
    translatableElements.forEach(element => {
        ...
        } else if (translations[key] && translations[key]['en']) { // Fallback to English if specific lang not found
...
// --- Code hiệu ứng hạt rơi ---
// ... (existing particle effect code remains unchanged) ...
...
function showPersona(persona) {
    if (persona === 'stellapaw') {
        ...
        // startParticleSystem('snow'); // Đã comment out để tạm ẩn hiệu ứng tuyết
        ...
        // startParticleSystem('sakura'); // Đã comment out để tạm ẩn hiệu ứng hoa anh đào
...
// Added Event Listener for Xueru button
if (meetXueruButton) {
    meetXueruButton.addEventListener('click', function() {
        // IMPORTANT: Replace with the actual URL for Xueru's website
        window.location.href = 'xueru';
        console.log('Meet Xueru button clicked');
    });
}
...
// LOGIC CHO VIDEO PLAYER 1 (featuredVideo)
...
// LOGIC CHO VIDEO PLAYER 2 (featuredVideo2)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    updateContent(currentLang); // This will also update the new Xueru button text
